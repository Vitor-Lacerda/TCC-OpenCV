...
void VerificaContornos(Mat D, vector<Vaga> &vagas, Mat imagem, bool simples,  Mat imagemBGR) {
...
void ComparaImagens(Mat &indicacoes, Mat a, Mat b, bool simples, vector<Vaga> &vagas) {
	...
	imshow("Diferenca", D);
	VerificaContornos(D, vagas, b, simples,  b);
...
int main(int argc, char** argv) {
	...
	//ComparaImagens(indicacoes, momento0, momento1, false, vagas);
